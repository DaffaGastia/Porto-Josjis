...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ║                                      ║
    ║ Contact:daffag.prabaswara21@gmail.com║
    ╚══════════════════════════════════════╝
    `);
...
// // ============= Twitter Bird Fly Animation =============
// const twitterBird = document.querySelector('.twitter-bird');

// if (twitterBird) {
//     let isAnimating = false;

//     twitterBird.addEventListener('mouseenter', function() {
//         if (isAnimating || window.innerWidth < 768) return; // Skip on mobile

//         const icon = this.querySelector('i');
//         isAnimating = true;

//         // 1. Flap wings for 0.6s
//         icon.style.animation = 'flapWings 0.6s ease-in-out';
        
//         setTimeout(() => {
//             // 2. Stop flapping, start flying away
//             icon.style.animation = 'none';
//             this.classList.add('flying-away');

//             setTimeout(() => {
//                 // 3. Fly back after 2s delay
//                 this.classList.remove('flying-away');
//                 this.classList.add('flying-back');

//                 setTimeout(() => {
//                     // 4. Reset
//                     this.classList.remove('flying-back');
//                     isAnimating = false;
//                     icon.style.animation = '';
//                 }, 800);

//             }, 2000); // delay before returning
...
// TikTok Dance Enhancer
// const tiktokIcon = document.querySelector('.tiktok-dance');
...
//             this.style.filter = 'drop-shadow(0 0 15px rgba(254, 44, 85, 0.8))';
//         }, 3000);
//     });
